...
# ASN.1 source file:///home/selby1jr/src/mibs/mibs.snmplabs.com/asn1/ARUBA-TC
...
TimeTicks, Counter64, Gauge32, Integer32, Bits, ObjectSyntax, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, iso, ModuleIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Gauge32", "Integer32", "Bits", "ObjectSyntax", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("ARUBA-TC", ArubaPortType=ArubaPortType, ArubaESIServerMode=ArubaESIServerMode, ArubaConfigurationChangeType=ArubaConfigurationChangeType, ArubaVoipRegState=ArubaVoipRegState, ArubaCardType=ArubaCardType, ArubaFlexRadioMode=ArubaFlexRadioMode, ArubaAPStatus=ArubaAPStatus, ArubaPortalServerDownReason=ArubaPortalServerDownReason, ArubaFrameType=ArubaFrameType, ArubaStationType=ArubaStationType, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, ArubaStackChangeEvent=ArubaStackChangeEvent, ArubaAPMatchMethod=ArubaAPMatchMethod, ArubaAPUplinkType=ArubaAPUplinkType, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaDot3azStatus=ArubaDot3azStatus, ArubaIfState=ArubaIfState, ArubaIfStateChangeReason=ArubaIfStateChangeReason, ArubaRogueApType=ArubaRogueApType, ArubaPortDuplex=ArubaPortDuplex, ArubaStackState=ArubaStackState, ArubaActiveState=ArubaActiveState, ArubaHashAlgorithms=ArubaHashAlgorithms, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, ArubaAccessPointMode=ArubaAccessPointMode, ArubaOperStateValue=ArubaOperStateValue, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, ArubaIfType=ArubaIfType, ArubaARMChangeReason=ArubaARMChangeReason, ArubaEncryptionType=ArubaEncryptionType, ArubaHTRate=ArubaHTRate, ArubaHaConnectivityStatus=ArubaHaConnectivityStatus, ArubaAuthenticationMethods=ArubaAuthenticationMethods, ArubaPoeState=ArubaPoeState, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, ArubaACLAction=ArubaACLAction, ArubaVlanValidRange=ArubaVlanValidRange, ArubaHTMode=ArubaHTMode, ArubaPortMode=ArubaPortMode, ArubaMonEncryptionType=ArubaMonEncryptionType, ArubaHTExtChannel=ArubaHTExtChannel, ArubaVoipProtocolType=ArubaVoipProtocolType, ArubaEnet1Mode=ArubaEnet1Mode, ArubaMeshRole=ArubaMeshRole, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, ArubaESIServerStatus=ArubaESIServerStatus, ArubaDBType=ArubaDBType, ArubaConfigurationState=ArubaConfigurationState, ArubaBlackListReason=ArubaBlackListReason, ArubaVoipProtocol=ArubaVoipProtocol, ArubaEncryptionMethods=ArubaEncryptionMethods, ArubaAPDot1dState=ArubaAPDot1dState, ArubaMonitorMode=ArubaMonitorMode, ArubaSupportStatus=ArubaSupportStatus, ArubaAddressType=ArubaAddressType, ArubaAntennaSetting=ArubaAntennaSetting, ArubaThresholdResourceType=ArubaThresholdResourceType, ArubaDaysOfWeek=ArubaDaysOfWeek, ArubaPortSpeed=ArubaPortSpeed, ArubaCallStates=ArubaCallStates, ArubaStackIfTopoJoined=ArubaStackIfTopoJoined, ArubaEnableValue=ArubaEnableValue, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, ArubaDot1dState=ArubaDot1dState, ArubaAuthServerType=ArubaAuthServerType, ArubaACLDomain=ArubaACLDomain, ArubaAPMatchType=ArubaAPMatchType, ArubaVrrpState=ArubaVrrpState, InterfaceIndex=InterfaceIndex, ArubaVoiceCacBit=ArubaVoiceCacBit, ArubaUserForwardMode=ArubaUserForwardMode, ArubaPhyType=ArubaPhyType, ArubaSwitchRole=ArubaSwitchRole, ArubaHaRole=ArubaHaRole)
