...
# Produced by pysmi-0.3.4 at Wed Jul 24 12:18:59 2024
...
ArubaConfigurationState, ArubaStationType, ArubaPortalServerDownReason, ArubaHTExtChannel, ArubaOperStateValue, ArubaPhyType, ArubaAPConductorStatus, ArubaFrameType, ArubaDBType, ArubaStackIfTopoJoined, ArubaIfState, ArubaAddressType, ArubaAuthenticationMethods, ArubaARMChangeReason, ArubaDenyListReason, ArubaEnableValue, ArubaStackState, ArubaHTMode, InterfaceIndex, ArubaIfStateChangeReason, ArubaConfigurationChangeType, ArubaAccessPointMode, ArubaStackChangeEvent, ArubaVrrpState, ArubaSwitchRole, ArubaAPUplinkChangeReason, ArubaAPMasterStatus, ArubaBlackListReason, ArubaThresholdResourceType, ArubaAPUplinkType = mibBuilder.importSymbols("ARUBA-TC", "ArubaConfigurationState", "ArubaStationType", "ArubaPortalServerDownReason", "ArubaHTExtChannel", "ArubaOperStateValue", "ArubaPhyType", "ArubaAPConductorStatus", "ArubaFrameType", "ArubaDBType", "ArubaStackIfTopoJoined", "ArubaIfState", "ArubaAddressType", "ArubaAuthenticationMethods", "ArubaARMChangeReason", "ArubaDenyListReason", "ArubaEnableValue", "ArubaStackState", "ArubaHTMode", "InterfaceIndex", "ArubaIfStateChangeReason", "ArubaConfigurationChangeType", "ArubaAccessPointMode", "ArubaStackChangeEvent", "ArubaVrrpState", "ArubaSwitchRole", "ArubaAPUplinkChangeReason", "ArubaAPMasterStatus", "ArubaBlackListReason", "ArubaThresholdResourceType", "ArubaAPUplinkType")
ObjectIdentifier, OctetString, Integer = mibBuilder.importSymbols("ASN1", "ObjectIdentifier", "OctetString", "Integer")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
SingleValueConstraint, ConstraintsUnion, ConstraintsIntersection, ValueSizeConstraint, ValueRangeConstraint = mibBuilder.importSymbols("ASN1-REFINEMENT", "SingleValueConstraint", "ConstraintsUnion", "ConstraintsIntersection", "ValueSizeConstraint", "ValueRangeConstraint")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Counter32, MibIdentifier, Integer32, iso, Unsigned32, ModuleIdentity, snmpModules, TimeTicks, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "iso", "Unsigned32", "ModuleIdentity", "snmpModules", "TimeTicks", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Bits")
TAddress, DateAndTime, TimeInterval, TextualConvention, RowStatus, DisplayString, MacAddress, TruthValue, TDomain, PhysAddress, StorageType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TAddress", "DateAndTime", "TimeInterval", "TextualConvention", "RowStatus", "DisplayString", "MacAddress", "TruthValue", "TDomain", "PhysAddress", "StorageType", "TestAndIncr")
...
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxAPNumWarmStarts=wlsxAPNumWarmStarts, wlsxTrapCrlName=wlsxTrapCrlName, wlsxNSwitchIPv6Changed=wlsxNSwitchIPv6Changed, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxPortalServerDown=wlsxPortalServerDown, wlsxTrapAPTxPower=wlsxTrapAPTxPower, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, wlsxThresholdCleared=wlsxThresholdCleared, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, wlsxCertExpiringSoon=wlsxCertExpiringSoon, wlsxTrapConnectionStatus=wlsxTrapConnectionStatus, wlsxNumClockSyncErrors=wlsxNumClockSyncErrors, wlsxAPPortDown=wlsxAPPortDown, wlsxCertExpired=wlsxCertExpired, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, wlsxNVpnMaxSessions=wlsxNVpnMaxSessions, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, wlsxAPDown=wlsxAPDown, wlsxAPNumColdStarts=wlsxAPNumColdStarts, wlsxTrapAPPhyType=wlsxTrapAPPhyType, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, wlsxMeshNodeEntryChanged=wlsxMeshNodeEntryChanged, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, wlsxFanTrayRemovedTrap=wlsxFanTrayRemovedTrap, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, wlsxNumColdStart=wlsxNumColdStart, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, wlsxTrapPeerIpAddress=wlsxTrapPeerIpAddress, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, wlsxAPIPConflict=wlsxAPIPConflict, wlsxNRapExpiredPSK=wlsxNRapExpiredPSK, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, wlsxVlanEntryChanged=wlsxVlanEntryChanged, wlsxTrapLocalName=wlsxTrapLocalName, wlsxPhonyBSSIDDetected=wlsxPhonyBSSIDDetected, wlsxNLowOnFlashSpace=wlsxNLowOnFlashSpace, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, wlsxNRogueAPDetected=wlsxNRogueAPDetected, wlsxGhostTunnelserverAttack=wlsxGhostTunnelserverAttack, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, wlsxTrapLicenseClientDaysRemaining=wlsxTrapLicenseClientDaysRemaining, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, wlsxNAdhocNetwork=wlsxNAdhocNetwork, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, wlsxTrapProcessName=wlsxTrapProcessName, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, wlsxTrapFanTrayNumber=wlsxTrapFanTrayNumber, wlsxClientFloodAttack=wlsxClientFloodAttack, wlsxNPowerSupplyFailure=wlsxNPowerSupplyFailure, wlsxNFanTrayInserted=wlsxNFanTrayInserted, wlsxNAuthMaxBWContracts=wlsxNAuthMaxBWContracts, wlsxNOutOfRangeVoltage=wlsxNOutOfRangeVoltage, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, wlsxTrapUserRole=wlsxTrapUserRole, wlsxNDot1xThresholdLimitHit=wlsxNDot1xThresholdLimitHit, wlsxConfigurationUpdateSucceeded=wlsxConfigurationUpdateSucceeded, wlsxAPPortUp=wlsxAPPortUp, wlsxTrapDefinitionsGroup=wlsxTrapDefinitionsGroup, wlsxBSSIDIsDown=wlsxBSSIDIsDown, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, wlsxAPUp=wlsxAPUp, wlsxNumWarmStart=wlsxNumWarmStart, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, wlsxIfStateChangeReason=wlsxIfStateChangeReason, wlsxAPDeauthContainment=wlsxAPDeauthContainment, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxEnhancedAdhocContainment=wlsxEnhancedAdhocContainment, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, wlsxNProcessDied=wlsxNProcessDied, wlsxMemoryUsageOK=wlsxMemoryUsageOK, wlsxThresholdValue=wlsxThresholdValue, wlsxNFanFailure=wlsxNFanFailure, wlsxFataJackAttack=wlsxFataJackAttack, wlsrTrapMIB=wlsrTrapMIB, wlsxTrapEssid=wlsxTrapEssid, wlsxStackMemberMacAddress=wlsxStackMemberMacAddress, wlsxTrapMatchedIp=wlsxTrapMatchedIp, wlsxTrapCount=wlsxTrapCount, wlsxStackProtoIfTopoJoined=wlsxStackProtoIfTopoJoined, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, wlsxTarpitContainment=wlsxTarpitContainment, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, wlsxTrapApMode=wlsxTrapApMode, wlsxWirelessHostedNetworkDetected=wlsxWirelessHostedNetworkDetected, wlsxTrapAPBand=wlsxTrapAPBand, wlsxCTSTransferSucceeded=wlsxCTSTransferSucceeded, PYSNMP_MODULE_ID=wlsrTrapMIB, wlsxReceiverMac=wlsxReceiverMac, wlsxSignatureMatchAP=wlsxSignatureMatchAP, wlsxTrapAPChannel=wlsxTrapAPChannel, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, wlsxClientAssociatedToHostedNetwork=wlsxClientAssociatedToHostedNetwork, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod, wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, wlsxThresholdResourceName=wlsxThresholdResourceName, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, wlsxTrapClientClassification=wlsxTrapClientClassification, wlsxLicenseType=wlsxLicenseType, wlsxNESIServerDown=wlsxNESIServerDown, wlsxValidSSIDViolation=wlsxValidSSIDViolation, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxTrapAddressType=wlsxTrapAddressType, wlsxStackPrevSlot=wlsxStackPrevSlot, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, wlsxAPBssidEntryChanged=wlsxAPBssidEntryChanged, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxCTSTransferError=wlsxCTSTransferError, wlsxFlash1SpaceOK=wlsxFlash1SpaceOK, wlsxNFanTrayRemoved=wlsxNFanTrayRemoved, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, wlsxSignStaAsleap=wlsxSignStaAsleap, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, wlsxTrapOperStatus=wlsxTrapOperStatus, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, wlsxNConnectionResetWithLocal=wlsxNConnectionResetWithLocal, wlsxNOutOfRangeTemperature=wlsxNOutOfRangeTemperature, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxSignatureMatchSta=wlsxSignatureMatchSta, wlsxWPAFTAttack=wlsxWPAFTAttack, wlsxLicenseClientExpiry=wlsxLicenseClientExpiry, wlsxVoiceClientLocationUpdate=wlsxVoiceClientLocationUpdate, wlsxPeerAssociatedToWifiDirectGoContainment=wlsxPeerAssociatedToWifiDirectGoContainment, wlsxTrapsGroup=wlsxTrapsGroup, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, wlsxTunnelUp=wlsxTunnelUp, wlsxTrapVoltageValue=wlsxTrapVoltageValue, wlsxNChannelChanged=wlsxNChannelChanged, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, wlsxMitMDetected=wlsxMitMDetected, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxNormalTemperature=wlsxNormalTemperature, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, wlsxClientWiredContainment=wlsxClientWiredContainment, wlsxVlanInterfaceEntryChanged=wlsxVlanInterfaceEntryChanged, wlsxNAdhocUsingValidSSIDContainment=wlsxNAdhocUsingValidSSIDContainment, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxEsiServerChanged=wlsxEsiServerChanged, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, wlsxUserEntryChanged=wlsxUserEntryChanged, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, wlsxIfIndex=wlsxIfIndex, wlsxAPNumDown=wlsxAPNumDown, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxTrapSignatureName=wlsxTrapSignatureName, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxWarmStart=wlsxWarmStart, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, wlsxAPChannelChange=wlsxAPChannelChange, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, wlsxGlobalConfigurationChangeNotification=wlsxGlobalConfigurationChangeNotification, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, wlsxInformQueueOverFlow=wlsxInformQueueOverFlow, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, wlsxConfigurationUpdateError=wlsxConfigurationUpdateError, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, wlsxTrapHostPort=wlsxTrapHostPort, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxTHERMALSHUTDOWN=wlsxTHERMALSHUTDOWN, wlsxTrapUserName=wlsxTrapUserName, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, wlsxTrapSwitchIpv6=wlsxTrapSwitchIpv6, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, wlsxNUserEntryCreated=wlsxNUserEntryCreated, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, wlsxTrapObjectsGroup=wlsxTrapObjectsGroup, wlsxHostOfWirelessNetworkContainment=wlsxHostOfWirelessNetworkContainment, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, wlsxTrapLicensePlatformMismatchKey=wlsxTrapLicensePlatformMismatchKey, wlsxPortalServerUp=wlsxPortalServerUp, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxAPWiredContainment=wlsxAPWiredContainment, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, wlsxTrapLicenseServerDaysRemaining=wlsxTrapLicenseServerDaysRemaining, wlsxNDBCommunicationFailure=wlsxNDBCommunicationFailure, wlsxLicensePlatformMismatch=wlsxLicensePlatformMismatch, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxNWebCCLicenseEnforcement=wlsxNWebCCLicenseEnforcement, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, wlsxNApOnBackupController=wlsxNApOnBackupController, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, wlsxStackPrevState=wlsxStackPrevState, wlsxNPowerSupplyMissing=wlsxNPowerSupplyMissing, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, wlsxCRLExpired=wlsxCRLExpired, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, wlsxTrapPowerSupplyNumber=wlsxTrapPowerSupplyNumber, wlsxPortUp=wlsxPortUp, wlsxVlanLinkUp=wlsxVlanLinkUp, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxAPPowerChange=wlsxAPPowerChange, wlsxLicenseThresholdLimitHit=wlsxLicenseThresholdLimitHit, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxFanOK=wlsxFanOK, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, wlsxTrapDBUserName=wlsxTrapDBUserName, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, wlsxNAceUsageThreshold=wlsxNAceUsageThreshold, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, wlsxTrapPhyType=wlsxTrapPhyType, wlsxTrapDBType=wlsxTrapDBType, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxStaPolicyViolation=wlsxStaPolicyViolation, wlsxTrapCardSlot=wlsxTrapCardSlot, wlsxReservedChannelViolation=wlsxReservedChannelViolation, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxLicensePoolName=wlsxLicensePoolName)
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxThresholdExceeded=wlsxThresholdExceeded, wlsxStaImpersonation=wlsxStaImpersonation, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, wlsxPortEntryChanged=wlsxPortEntryChanged, wlsxTrapAPCurMode=wlsxTrapAPCurMode, wlsxVlanLinkDown=wlsxVlanLinkDown, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, wlsxTrapExpiredCertName=wlsxTrapExpiredCertName, wlsxStackCurrentState=wlsxStackCurrentState, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, wlsxNFanAbsent=wlsxNFanAbsent, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, wlsxChopChopAttack=wlsxChopChopAttack, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxStackCurrentSlot=wlsxStackCurrentSlot, wlsxNConnectionBackfromLocal=wlsxNConnectionBackfromLocal, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, wlsxNLowOnFlash1Space=wlsxNLowOnFlash1Space, wlsxNLicenseExpiry=wlsxNLicenseExpiry, wlsxNLowMemory=wlsxNLowMemory, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxGhostTunnelclientAttack=wlsxGhostTunnelclientAttack, wlsxInRangeVoltage=wlsxInRangeVoltage, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, wlsxTunnelDown=wlsxTunnelDown, wlsxBSSIDIsUp=wlsxBSSIDIsUp, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxIfState=wlsxIfState, wlsxProcessRestart=wlsxProcessRestart, wlsxTrapMasterIp=wlsxTrapMasterIp, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, wlsxNGBICInserted=wlsxNGBICInserted, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, wlsxTrapSourceMac=wlsxTrapSourceMac, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxTrapVrrpID=wlsxTrapVrrpID, wlsxTrapAPLocation=wlsxTrapAPLocation, wlsxSwitchListEntryChanged=wlsxSwitchListEntryChanged, wlsxNRapWarnExpiredPSK=wlsxNRapWarnExpiredPSK, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, wlsxIfStateChangeTrap=wlsxIfStateChangeTrap, wlsxNeighborAPDetected=wlsxNeighborAPDetected, wlsxNSwitchIPChanged=wlsxNSwitchIPChanged, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, wlsxOverflowIEDetected=wlsxOverflowIEDetected, wlsxNDot1xTotalLimitHit=wlsxNDot1xTotalLimitHit, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxConfigurationLicenseMismatch=wlsxConfigurationLicenseMismatch, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxPowerSupplyMissingTrap=wlsxPowerSupplyMissingTrap, wlsxTrapDBName=wlsxTrapDBName, wlsxTrapExpiringCertName=wlsxTrapExpiringCertName, wlsxSignatureMatch=wlsxSignatureMatch, wlsxFlashSpaceOK=wlsxFlashSpaceOK, wlsxMonAPEntryChanged=wlsxMonAPEntryChanged, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, wlsxVoiceCdrBufferThresholdReached=wlsxVoiceCdrBufferThresholdReached, wlsxValidClientMisassociation=wlsxValidClientMisassociation, wlsxAPNumRadioDown=wlsxAPNumRadioDown, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, wlsxStackIfStateChangeTrap=wlsxStackIfStateChangeTrap, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, wlsxTrapFrameType=wlsxTrapFrameType, wlsxSignAPAsleap=wlsxSignAPAsleap, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, wlsxTrapDeviceMac=wlsxTrapDeviceMac, wlsxResourceValue=wlsxResourceValue, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxTrapESIServerName=wlsxTrapESIServerName, wlsxNAuthMaxXsecUserEntries=wlsxNAuthMaxXsecUserEntries, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, wlsxAPEntryChanged=wlsxAPEntryChanged, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, wlsxNAuthMaxUserEntries=wlsxNAuthMaxUserEntries, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, wlsxPowerSupplyOKTrap=wlsxPowerSupplyOKTrap, wlsxFanTrayInsertedTrap=wlsxFanTrayInsertedTrap, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxCoverageHoleResolved=wlsxCoverageHoleResolved, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, wlsxTrapTimeStr=wlsxTrapTimeStr, wlsxNVrrpStateChange=wlsxNVrrpStateChange, wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, wlsxTrapSnr=wlsxTrapSnr, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, wlsxNLCRemoved=wlsxNLCRemoved, wlsxTrapAPHTMode=wlsxTrapAPHTMode, wlsxNIpSpoofingDetected=wlsxNIpSpoofingDetected, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxAPNumUpgradeFailure=wlsxAPNumUpgradeFailure, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, wlsxTrapReceiverMac=wlsxTrapReceiverMac, wlsxTrapLicenseId=wlsxTrapLicenseId, wlsxNSignatureMatch=wlsxNSignatureMatch, wlsxTrapPortalServerName=wlsxTrapPortalServerName, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, wlsxLicenseEntryChanged=wlsxLicenseEntryChanged, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, wlsxLicenseServerExpiry=wlsxLicenseServerExpiry, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxTrapTunnelId=wlsxTrapTunnelId, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, wlsxNSCInserted=wlsxNSCInserted, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxOmertaAttack=wlsxOmertaAttack, wlsxAPModeChange=wlsxAPModeChange, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, wlsxApFloodAttack=wlsxApFloodAttack, wlsxTrapNodeMac=wlsxTrapNodeMac, wlsxSignAPAirjack=wlsxSignAPAirjack, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, wlsxNESIServerUp=wlsxNESIServerUp, wlsxTrapHTMode=wlsxTrapHTMode, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, wlsxSignalAnomaly=wlsxSignalAnomaly, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxPowerSupplyOK=wlsxPowerSupplyOK, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, wlsxStackMemberSlotNumber=wlsxStackMemberSlotNumber, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, wlsxNCoverageHoleDetected=wlsxNCoverageHoleDetected, wlsxWMSOffloadRecommended=wlsxWMSOffloadRecommended, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, wlsxTrapMasterName=wlsxTrapMasterName, wlsxNSwitchRoleChange=wlsxNSwitchRoleChange, wlsxStackChangeEvent=wlsxStackChangeEvent, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, wlsxAPImpersonation=wlsxAPImpersonation, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, wlsxTrapSwitchRole=wlsxTrapSwitchRole, wlsxTrapConfigurationState=wlsxTrapConfigurationState, wlsxStackTopologyChangeTrap=wlsxStackTopologyChangeTrap, wlsxTrapTargetAPMac=wlsxTrapTargetAPMac, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, wlsxTrapDeviceIpv6Address=wlsxTrapDeviceIpv6Address, wlsxAPRadioEntryChanged=wlsxAPRadioEntryChanged, wlsxStackIfName=wlsxStackIfName, wlsxColdStart=wlsxColdStart, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, wlsxMonStationEntryChanged=wlsxMonStationEntryChanged, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, wlsxTrapTargetAPName=wlsxTrapTargetAPName, wlsxTrapTime=wlsxTrapTime, wlsxNAuthMaxAclEntries=wlsxNAuthMaxAclEntries, wlsxTrapHostIp=wlsxTrapHostIp, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, wlsxThresholdResourceType=wlsxThresholdResourceType, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, wlsxWirelessBridge=wlsxWirelessBridge, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, wlsxClusterVlanProbeStatus=wlsxClusterVlanProbeStatus, wlsxTrapCaName=wlsxTrapCaName, wlsxPortDown=wlsxPortDown, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, wlsxTrapFailedVlan=wlsxTrapFailedVlan, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxTrapVlanId=wlsxTrapVlanId, wlsxNProcessExceedsMemoryLimits=wlsxNProcessExceedsMemoryLimits, wlsxPowerSupplyFailureTrap=wlsxPowerSupplyFailureTrap, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxWirelessHostedNetworkContainment=wlsxWirelessHostedNetworkContainment, wlsxNLCInserted=wlsxNLCInserted, wlsxPeerAssociatedToWifiDirectGo=wlsxPeerAssociatedToWifiDirectGo, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxTrapAPName=wlsxTrapAPName)
