...
# ASN.1 source file:///home/selby1jr/src/mibs/mibs.snmplabs.com/asn1/AI-AP-MIB
# Produced by pysmi-0.3.4 at Wed Jul 24 12:18:48 2024
...
Counter64, ObjectIdentity, MibIdentifier, snmpModules, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, IpAddress, Bits, Gauge32, Unsigned32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "MibIdentifier", "snmpModules", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "IpAddress", "Bits", "Gauge32", "Unsigned32", "Integer32", "NotificationType")
DisplayString, TextualConvention, DateAndTime, StorageType, TimeInterval, RowStatus, MacAddress, TestAndIncr, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "DateAndTime", "StorageType", "TimeInterval", "RowStatus", "MacAddress", "TestAndIncr", "PhysAddress", "TruthValue")
...
aiClientTxDataBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 2, 4, 1, 9), Counter64()).setMaxAccess("readonly")
...
aiClientRxDataBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 2, 4, 1, 13), Counter64()).setMaxAccess("readonly")
...
wlsxPeerAssociatedToWifiDirectGo = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1291)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxPeerAssociatedToWifiDirectGo.setStatus('current')
wlsxPeerAssociatedToWifiDirectGoContainment = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1292)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxPeerAssociatedToWifiDirectGoContainment.setStatus('current')
mibBuilder.exportSymbols("AI-AP-MIB", wlsxTrapDBUserName=wlsxTrapDBUserName, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, aiMIB=aiMIB, wlsxWirelessBridge=wlsxWirelessBridge, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, wlsxTrapAPBand=wlsxTrapAPBand, wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, wlsxStaPolicyViolation=wlsxStaPolicyViolation, ArubaACLDomain=ArubaACLDomain, aiMeshPortalMac=aiMeshPortalMac, wlsxTrapMasterIp=wlsxTrapMasterIp, aiVirtualControllerKey=aiVirtualControllerKey, wlsxNUserEntryCreated=wlsxNUserEntryCreated, wlsxPortalServerUp=wlsxPortalServerUp, aiInterferAPBSSID=aiInterferAPBSSID, wlsxAPPowerChange=wlsxAPPowerChange, wlsxTrapOperStatus=wlsxTrapOperStatus, aiSSIDHide=aiSSIDHide, ArubaFrameType=ArubaFrameType, aiClientHtMode=aiClientHtMode, wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, wlsxAPImpersonation=wlsxAPImpersonation, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, ArubaAuthenticationMethods=ArubaAuthenticationMethods, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, aiWlanTable=aiWlanTable, wlsxOmertaAttack=wlsxOmertaAttack, ArubaPortDuplex=ArubaPortDuplex, aiAPIPAddress=aiAPIPAddress, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, ArubaVoipProtocol=ArubaVoipProtocol, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, aiMeshHops=aiMeshHops, wlsxTrapReceiverMac=wlsxTrapReceiverMac, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, aiClientName=aiClientName, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, wlsxTrapSourceMac=wlsxTrapSourceMac, ArubaPortMode=ArubaPortMode, PYSNMP_MODULE_ID=aiMIB, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, wlsxTrapProcessName=wlsxTrapProcessName, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, aiClientSNR=aiClientSNR, ArubaEnet1Mode=ArubaEnet1Mode, ArubaESIServerStatus=ArubaESIServerStatus, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, aiRadioRxMgmtFrames=aiRadioRxMgmtFrames, aiRadioUtilization4=aiRadioUtilization4, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxReservedChannelViolation=wlsxReservedChannelViolation, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, aiAccessPointEntry=aiAccessPointEntry, wlsxApFloodAttack=wlsxApFloodAttack, aiClientPhyType=aiClientPhyType, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, aiWlanEntry=aiWlanEntry, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, aiInterferAccessPointTable=aiInterferAccessPointTable, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, aiRadioEntry=aiRadioEntry, aiInterferAPESSID=aiInterferAPESSID, wlsxTrapSignatureName=wlsxTrapSignatureName, ArubaVoipRegState=ArubaVoipRegState, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, wlsxTrapTime=wlsxTrapTime, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, ArubaPortType=ArubaPortType, wlsxTrapVrrpID=wlsxTrapVrrpID, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, ArubaVlanValidRange=ArubaVlanValidRange, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxTrapAPPhyType=wlsxTrapAPPhyType, ArubaEncryptionMethods=ArubaEncryptionMethods, ArubaDot1dState=ArubaDot1dState, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, ArubaACLAction=ArubaACLAction, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxTrapDBName=wlsxTrapDBName, aiMeshIndex=aiMeshIndex, ArubaActiveState=ArubaActiveState, ArubaHTRate=ArubaHTRate, wlsxTrapPortalServerName=wlsxTrapPortalServerName, wlsxTrapAddressType=wlsxTrapAddressType, aiWlanSSIDEntry=aiWlanSSIDEntry, aiStateGroup=aiStateGroup, ArubaPortalServerDownReason=ArubaPortalServerDownReason, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, ArubaAntennaSetting=ArubaAntennaSetting, aiWlanIndex=aiWlanIndex, ArubaHTMode=ArubaHTMode, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, ArubaHashAlgorithms=ArubaHashAlgorithms, wlsxNeighborAPDetected=wlsxNeighborAPDetected, wlsxAPDeauthContainment=wlsxAPDeauthContainment, ArubaAPStatus=ArubaAPStatus, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, ArubaOperStateValue=ArubaOperStateValue, aiRadioRxDataBytes=aiRadioRxDataBytes, wlsxSignAPAirjack=wlsxSignAPAirjack, ArubaSupportStatus=ArubaSupportStatus, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, aiMeshPointMac=aiMeshPointMac, aiInterferAPType=aiInterferAPType, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, aiInterferAPPhyType=aiInterferAPPhyType, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, wlsxMitMDetected=wlsxMitMDetected, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxTrapSnr=wlsxTrapSnr, aiMasterIPAddress=aiMasterIPAddress, aiManagedModeSinceLastSync=aiManagedModeSinceLastSync, aiWlanTxTotalFrames=aiWlanTxTotalFrames, ArubaConfigurationChangeType=ArubaConfigurationChangeType, aiMeshAge=aiMeshAge, wlsxTrapTimeStr=wlsxTrapTimeStr, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxTrapConductorIp=wlsxTrapConductorIp, aiAPUptime=aiAPUptime, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, wlsxTrapCount=wlsxTrapCount, aiSSID=aiSSID, aiRadioTxDataBytes=aiRadioTxDataBytes, aiTrapsGroup=aiTrapsGroup, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxClientFloodAttack=wlsxClientFloodAttack, aiConductorIPAddress=aiConductorIPAddress, aiAPCPUUtilization=aiAPCPUUtilization, aiWlanAPMACAddress=aiWlanAPMACAddress, ArubaMonitorMode=ArubaMonitorMode, aiSSIDStatus=aiSSIDStatus, ArubaVoiceCacBit=ArubaVoiceCacBit, wlsxTrapVoltageValue=wlsxTrapVoltageValue, aiVirtualControllerOrganization=aiVirtualControllerOrganization, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, aiRadioTxMgmtFrames=aiRadioTxMgmtFrames, wlsxReceiverMac=wlsxReceiverMac, wlsxTrapUserRole=wlsxTrapUserRole, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, aiInterferAPChannel=aiInterferAPChannel, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, aiRadioMACAddress=aiRadioMACAddress, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, ArubaESIServerMode=ArubaESIServerMode, aiClientRxRate=aiClientRxRate, aiInterferAccessPointEntry=aiInterferAccessPointEntry, aiMeshAvgRssi=aiMeshAvgRssi, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, wlsxSignatureMatchAP=wlsxSignatureMatchAP, wlsxTrapAPName=wlsxTrapAPName, wlsxNRogueAPDetected=wlsxNRogueAPDetected, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, aiRadioClientNum=aiRadioClientNum, wlsxTrapCardSlot=wlsxTrapCardSlot, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, aiRadioChannel=aiRadioChannel, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, aiAPName=aiAPName, aiRadioUtilization64=aiRadioUtilization64, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, ArubaDaysOfWeek=ArubaDaysOfWeek, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, aiClientRxDataFrames=aiClientRxDataFrames, aiSSIDIndex=aiSSIDIndex, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, ArubaEncryptionType=ArubaEncryptionType, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxTrapDeviceMac=wlsxTrapDeviceMac, wlsxSignAPAsleap=wlsxSignAPAsleap, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, wlsxAPModeChange=wlsxAPModeChange, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, aiClientEntry=aiClientEntry, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, wlsxTrapTunnelId=wlsxTrapTunnelId, wlsxWarmStart=wlsxWarmStart, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, aiAPStatus=aiAPStatus, wlsxTrapAPChannel=wlsxTrapAPChannel, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, aiWlanRxDataBytes=aiWlanRxDataBytes, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, wlsxClientWiredContainment=wlsxClientWiredContainment, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, wlsxTrapDBType=wlsxTrapDBType, wlsxTrapLocalName=wlsxTrapLocalName, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, aiAPTotalMemory=aiAPTotalMemory, aiMeshRelation=aiMeshRelation, ArubaUSBStatus=ArubaUSBStatus, aiAPHwopmode=aiAPHwopmode, aiAccessPointTable=aiAccessPointTable, aiAPSerialNum=aiAPSerialNum, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, ArubaDBType=ArubaDBType)
mibBuilder.exportSymbols("AI-AP-MIB", aiWlanTxDataBytes=aiWlanTxDataBytes, wlsxTrapCaName=wlsxTrapCaName, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxTrapESIServerName=wlsxTrapESIServerName, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, aiVoiceClientTable=aiVoiceClientTable, ArubaVoipProtocolType=ArubaVoipProtocolType, aiWlanMACAddress=aiWlanMACAddress, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, aiWlanESSID=aiWlanESSID, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, aiInterferAPEncr=aiInterferAPEncr, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, wlsxTrapEssid=wlsxTrapEssid, wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, aiRadioRxBad=aiRadioRxBad, wlsxPortalServerDown=wlsxPortalServerDown, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, ArubaPhyType=ArubaPhyType, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, ArubaAPUplinkType=ArubaAPUplinkType, wlsxTrapAPLocation=wlsxTrapAPLocation, aiInterferAPIndex=aiInterferAPIndex, ArubaDenyListReason=ArubaDenyListReason, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, ArubaHTExtChannel=ArubaHTExtChannel, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, aiRadioRxTotalFrames=aiRadioRxTotalFrames, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, wlsxTrapFrameType=wlsxTrapFrameType, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, aiTrapDefinitionsGroup=aiTrapDefinitionsGroup, aiClientTxDataBytes=aiClientTxDataBytes, aiMeshEntry=aiMeshEntry, wlsxNAdhocNetwork=wlsxNAdhocNetwork, aiClientRxDataBytes=aiClientRxDataBytes, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, aiClientTxRate=aiClientTxRate, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, wlsxTrapMasterName=wlsxTrapMasterName, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, ArubaAPConductorStatus=ArubaAPConductorStatus, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, aiAPRole=aiAPRole, aiMeshCost=aiMeshCost, wlsxTrapUserName=wlsxTrapUserName, aiInfoGroup=aiInfoGroup, aiWlanSSIDTable=aiWlanSSIDTable, aiAPModel=aiAPModel, aiClientTable=aiClientTable, wlsxStaImpersonation=wlsxStaImpersonation, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, aiRadioTxTotalFrames=aiRadioTxTotalFrames, aiAPMemoryFree=aiAPMemoryFree, aiRadioRxDataFrames=aiRadioRxDataFrames, aiRadioAPMACAddress=aiRadioAPMACAddress, ArubaPortSpeed=ArubaPortSpeed, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, wlsxTrapAPHTMode=wlsxTrapAPHTMode, ArubaARMChangeReason=ArubaARMChangeReason, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, aiRadioTransmitPower=aiRadioTransmitPower, aiClientTxDataFrames=aiClientTxDataFrames, aiRadioTxDataFrames=aiRadioTxDataFrames, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, aiTrapObjectsGroup=aiTrapObjectsGroup, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, aiWlanTxDataFrames=aiWlanTxDataFrames, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxFataJackAttack=wlsxFataJackAttack, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, aiRadioPhyEvents=aiRadioPhyEvents, aiClientUptime=aiClientUptime, aiRadioStatus=aiRadioStatus, aiClientAPIPAddress=aiClientAPIPAddress, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxTrapLicenseId=wlsxTrapLicenseId, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, aiRadioIndex=aiRadioIndex, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxTrapAPCurMode=wlsxTrapAPCurMode, ArubaPoeState=ArubaPoeState, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, aiClientAPMac=aiClientAPMac, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, wlsxWPAFTAttack=wlsxWPAFTAttack, ArubaCallStates=ArubaCallStates, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, aiClientMac=aiClientMac, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxChopChopAttack=wlsxChopChopAttack, ArubaBlackListReason=ArubaBlackListReason, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, ArubaCardType=ArubaCardType, wlsxTrapHostPort=wlsxTrapHostPort, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, wlsxNChannelChanged=wlsxNChannelChanged, ArubaMeshRole=ArubaMeshRole, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, ArubaMonEncryptionType=ArubaMonEncryptionType, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, aiAPMACAddress=aiAPMACAddress, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, wlsxTrapCrlName=wlsxTrapCrlName, wlsxColdStart=wlsxColdStart, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, aiManagedInfoGroup=aiManagedInfoGroup, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, ArubaStationType=ArubaStationType, wlsxOverflowIEDetected=wlsxOverflowIEDetected, aiMeshChannel=aiMeshChannel, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, ArubaRogueApType=ArubaRogueApType, aiWlanRxTotalFrames=aiWlanRxTotalFrames, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxTrapSwitchRole=wlsxTrapSwitchRole, wlsxTrapNodeMac=wlsxTrapNodeMac, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, ArubaAPMatchMethod=ArubaAPMatchMethod, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxTrapHostIp=wlsxTrapHostIp, aiClientWlanMACAddress=aiClientWlanMACAddress, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, wlsxAPWiredContainment=wlsxAPWiredContainment, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, wlsxNSignatureMatch=wlsxNSignatureMatch, aiClientIP=aiClientIP, aiSSIDClientNum=aiSSIDClientNum, wlsxPeerAssociatedToWifiDirectGoContainment=wlsxPeerAssociatedToWifiDirectGoContainment, aiClientIPAddress=aiClientIPAddress, aiAPModelName=aiAPModelName, wlsxTrapMatchedIp=wlsxTrapMatchedIp, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, ArubaAPMatchType=ArubaAPMatchType, aiVirtualControllerVersion=aiVirtualControllerVersion, ArubaEnableValue=ArubaEnableValue, aiInterferAPAvgSnr=aiInterferAPAvgSnr, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, aiClientMACAddress=aiClientMACAddress, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, aiClientOperatingSystem=aiClientOperatingSystem, aiClientTxRetries=aiClientTxRetries, aiVirtualControllerName=aiVirtualControllerName, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, wlsxSignalAnomaly=wlsxSignalAnomaly, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaConfigurationState=ArubaConfigurationState, ArubaAccessPointMode=ArubaAccessPointMode, wlsxSignatureMatchSta=wlsxSignatureMatchSta, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, ArubaAddressType=ArubaAddressType, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, aiWlanRxDataFrames=aiWlanRxDataFrames, wlsxTrapAPTxPower=wlsxTrapAPTxPower, aiVoiceClientEntry=aiVoiceClientEntry, ArubaIfType=ArubaIfType, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxTarpitContainment=wlsxTarpitContainment, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, wlsxPeerAssociatedToWifiDirectGo=wlsxPeerAssociatedToWifiDirectGo, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, aiRadioTable=aiRadioTable, ArubaVrrpState=ArubaVrrpState, wlsxTrapConductorName=wlsxTrapConductorName, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, wlsxValidSSIDViolation=wlsxValidSSIDViolation, aiRadioNoiseFloor=aiRadioNoiseFloor, aiMeshTable=aiMeshTable, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, wlsxValidClientMisassociation=wlsxValidClientMisassociation, aiClientAPName=aiClientAPName, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxAPChannelChange=wlsxAPChannelChange, ArubaUserForwardMode=ArubaUserForwardMode, aiVirtualControllerIPAddress=aiVirtualControllerIPAddress, aiRadioTxDrops=aiRadioTxDrops, wlsxTrapApMode=wlsxTrapApMode, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, wlsxTrapVlanId=wlsxTrapVlanId, ArubaSwitchRole=ArubaSwitchRole, wlsxSignStaAsleap=wlsxSignStaAsleap, aiRadioMode=aiRadioMode, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, ArubaAuthServerType=ArubaAuthServerType, wlsxTrapConfigurationState=wlsxTrapConfigurationState, aiClientRxRetries=aiClientRxRetries)
